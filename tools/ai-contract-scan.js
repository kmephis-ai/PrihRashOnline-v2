...
requireMatch('AI_CANONICAL_ROADMAP_REFERENCE', agents, /docs\/ROADMAP\.md[\s\S]{0,220}Executable GitHub Roadmap v2\.5/i, 'repository Roadmap v2.5 authority missing');
...
requireMatch('AI_CANONICAL_ROADMAP_FILE', roadmap, /^# PrihRashOnline-v2 — Executable GitHub Roadmap v2\.5$/m, 'docs/ROADMAP.md is not v2.5');
...
requireMatch('AI_CONTEXT_ROADMAP', context, /docs\/ROADMAP\.md[\s\S]{0,160}Executable GitHub Roadmap v2\.5/i, 'AI context Roadmap v2.5 authority missing');
requireMatch('AI_CONTEXT_POST_LF', context, /MASTER-LF-PRODUCT[\s\S]{0,1200}PLAN-REC-001/i, 'AI context post-LF Product Recovery scope missing');
...
for (const [name, text] of [
  ...
  forbidMatch('AI_STALE_ROADMAP_REFERENCE', text, /Executable GitHub Roadmap v2\.(?:1|2|3|4)\b/i, `${name} contains stale Roadmap authority`);
