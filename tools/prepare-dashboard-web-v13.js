...
const REPLACEMENTS = [
  ...
  {
    name: 'fixture executive and synthetic drilldown data',
    before: `        insight: {\n          title: 'Главный вывод',\n          text: 'В 2026 году доход выбранного года снизился на 14%. Доля года в общей истории: 17,6%.',\n          tone: 'warning'\n        },\n        navigation: {\n`,
    after: `        insight: {\n          title: 'Главный вывод',\n          text: 'В 2026 году доход выбранного года снизился на 14%. Доля года в общей истории: 17,6%.',\n          tone: 'warning'\n        },\n        executive: {\n          selectedYearIncome:3322811, selectedMonthIncome:151360, monthChange:-.689, yearChange:.44,\n          baseIncome:2840000, specialIncome:482811, forecast:5350000, stabilityIndex:50, qualityScore:86,\n          activeMonths:7, averageOperation:16818, largestSource:{label:'Источник A',value:1200000},\n          otherShare:.39, largeOperationCount:5, possibleDuplicateCount:1, yearOperationCount:128, monthOperationCount:9,\n          reasons:{\n            month:'Наибольший вклад в изменение месяца формирует один из основных источников.',\n            year:'Сравнение года выполняется по сопоставимому диапазону месяцев.',\n            special:'Специальные доходы учитываются отдельно от базового потока.'\n          }\n        },\n        drilldowns: {\n          year:{title:'Доход выбранного года',count:128,total:3322811,rows:[],openFirstUrl:'#'},\n          month:{title:'Доход выбранного месяца',count:9,total:151360,rows:[\n            {row:1001,id:'DEMO-001',date:'01.07.2026',amount:50000,category:'Пример A',description:'Синтетическая операция',status:'DEMO',flags:[],openUrl:'#'},\n            {row:1002,id:'DEMO-002',date:'02.07.2026',amount:60000,category:'Пример B',description:'Синтетическая операция',status:'DEMO',flags:[],openUrl:'#'},\n            {row:1003,id:'DEMO-003',date:'03.07.2026',amount:41360,category:'Пример C',description:'Синтетическая операция',status:'DEMO',flags:[],openUrl:'#'}\n          ],openFirstUrl:'#'},\n          previousMonth:{title:'Предыдущий месяц',count:17,total:487305,rows:[],openFirstUrl:'#'},\n          previousYear:{title:'Сопоставимый период прошлого года',count:0,total:0,rows:[],openFirstUrl:'#'},\n          base:{title:'Базовые доходы',count:0,total:2840000,rows:[],openFirstUrl:'#'},\n          special:{title:'Специальные доходы',count:0,total:482811,rows:[],openFirstUrl:'#'},\n          largestSource:{title:'Крупнейший источник',count:0,total:0,rows:[],openFirstUrl:'#'},\n          other:{title:'Категория «Другое»',count:0,total:0,rows:[],openFirstUrl:'#'},\n          large:{title:'Крупные операции',count:5,total:0,rows:[],openFirstUrl:'#'},\n          duplicates:{title:'Возможные точные дубли',count:2,total:0,groupCount:1,rows:[],openFirstUrl:'#'},\n          quality:{title:'Операции, требующие контроля качества',count:0,total:0,rows:[],openFirstUrl:'#'}\n        },\n        navigation: {\n`
  },
  {
