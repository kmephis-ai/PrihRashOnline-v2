...
function prhShowIncomeSidebar() {
  var html = HtmlService.createHtmlOutputFromFile('IncomeSidebar')
    .setTitle('Доходы')
    .setWidth(360);
...
function prhApplyIncomeSidebarFilters(payload) {
  ...
  var dashboard = prhIncomeSidebarSheet_();
  dashboard.getRangeList([PRH_INCOME_SIDEBAR.MODE_CELL,PRH_INCOME_SIDEBAR.YEAR_CELL,PRH_INCOME_SIDEBAR.MONTH_CELL,PRH_INCOME_SIDEBAR.CATEGORY_CELL,PRH_INCOME_SIDEBAR.MIN_AMOUNT_CELL])
    .setValues([[mode],[year],[month],[category],[minAmount]]);
