...
assert(localFirstStudioHtml.includes('href="?surface=gallery"'));
assert(localFirstStudioHtml.includes('Галерея экспертных дашбордов'));
assert(localFirstStudioHtml.includes('Открыть галерею'));
assert(html.includes('href="?surface=local-first#studio"'));
